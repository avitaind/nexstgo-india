	...
	jQuery.fn.extend({
		...
		********************************/
		...
		function createArrows(container,opt) {
						...
						container.parent().append('<div style="'+hidden+'" class="tp-leftarrow tparrows '+opt.device+' '+arst+'"></div>');
						container.parent().append('<div style="'+hidden+'" class="tp-rightarrow tparrows '+opt.device+' '+arst+'"></div>');
